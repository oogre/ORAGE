...
namespace ogre {
    ...
    cinder::gl::TextureRef    ModuleCommon::mSimpleTexture;
    ...
    template<typename DataType>
    void ModuleBase<DataType>::draw(){
        ModuleCommon::draw();
    }

    template<typename DataType>
    void ModuleBase<DataType>::displaySelectionRank(int rank){
        ModuleCommon::displaySelectionRank(rank);
    }
