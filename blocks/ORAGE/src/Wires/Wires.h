...
namespace ogre {
    ...
    class Wires{
        ...
        static uint8_t statusVideo;
        //static uint8_t statusPiano;
        static uint8_t NULL_STATUS;
        static uint8_t SLAVE_STATUS;
        static uint8_t MASTER_STATUS;
